...
namespace DFACore.Repository
{
    public class ApplicantRecordRepository : IApplicantRecordRepository
    {
        ...
        public List<ApplicantRecord> GetByCodeWithoutDash(string code)
        {
            var applicant = _context.ApplicantRecords.Where(a => a.ApplicationCode.Replace("-", "").Contains(code)).ToList();
            return applicant;
        }
